...
This directory contains the files necessary for running the DocBook Webhelp version 18.1 family of transformations from a command line. The Webhelp output files are exactly the same as for the DocBook Webhelp transformations executed inside the Oxygen XML Editor 18.1 application.
