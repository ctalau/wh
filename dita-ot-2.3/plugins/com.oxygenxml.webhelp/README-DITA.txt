...
This directory contains the Oxygen Webhelp plugin version 18.1 for DITA Open Toolkit. The Webhelp output files are exactly the same as for the DITA Webhelp transformations executed inside the Oxygen XML Editor 18.1 application. The plugin must be first integrated in the DITA Open Toolkit for adding the following transformation types to the DITA Open Toolkit:
...
- DITA Open Toolkit 1.8.x or 2.x (the 'full easy install' distribution)
...
1. Download and install a Java Virtual Machine 1.6 or later and a DITA Open Toolkit 1.8.x or 2.x (the 'full easy install' distribution) if you don't have them already installed:
...
2.1 For the DITA OT 2.x integration also rename the "plugin_2.x.xml" file to "plugin.xml". 
...
- [webhelp.transtype] must be one of the values: webhelp, webhelp-responsive, webhelp-feedback, webhelp-mobile
...
IMPORTANT NOTE: If you use DITA-OT version 2.0 you must remove all references to the patches JARs.
