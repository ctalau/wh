        ...
        success: function (data_response) {
            ...
            if (response.loggedIn == 'true') {
                ...
                if (response.level != "user") {
                    $("#accountInfo").append("<input id='adminLink' type='button' value=\"" + getLocalization("label.adminPanel") + "\" onclick='setLastPage(); window.location=\"" + conf.htpath + "resources/admin.html\"' />");
                }
