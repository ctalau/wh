    ...
    <div class="panel" id="cfgPanel" style="display: none;">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" name="productName" value="<?php echo sval('productName', __PRODUCT_NAME__); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" name="baseUrl" onfocus="this.blur()" readonly="readonly"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" name="smtp" onfocus="this.blur()" readonly="readonly"
            ...
            <tr>
                ...
                <td><input type="text" size="45" name="email" value="<?php echo sval('email', __EMAIL__); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" name="sesLifeTime" value="<?php echo sval('sesLifeTime', __SESSION_LIFETIME__); ?>"
    ...
    <div class="panel" id="ldapPanel" style="display:none;">
        ...
        <table>
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="ldapHost" name="ldapHost" value="<?php echo sval('ldapHost', LDAP_SERVER); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="ldapPort" name="ldapPort" value="<?php echo sval('ldapPort', LDAP_PORT); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="ldapUser" name="ldapUser" value="<?php echo sval('ldapUser', LDAP_USERNAME); ?>"
                           title="LDAP Username"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="password" size="45" id="ldapPass" name="ldapPass" value="<?php echo sval('ldapPass', LDAP_PASSWORD); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="accBase" name="accBase" value="<?php echo sval('accBase', LDAP_ACCOUNT_BASE); ?>"
            ...
            <tr>
                ...
                <td>
                    <select id="bindScope" name="bindScope" title="LDAP Search Scope">
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="userPattern" name="userPattern" value="<?php echo sval('userPattern', LDAP_USER_PATTERN); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="accFullName" name="accFullName" value="<?php echo sval('accFullName', LDAP_ACCOUNT_FULLNAME); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="accEmail" name="accEmail" value="<?php echo sval('accEmail', LDAP_ACCOUNT_EMAIL); ?>"
    ...
    <div class="panel" id="dbPanel" style="display:none;">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="dbhost" name="dbhost" value="<?php echo sval('dbhost', $dbConnectionInfo['dbHost']); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="dbname" name="dbname" value="<?php echo sval('dbname', $dbConnectionInfo['dbName']); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" size="45" id="dbuser" name="dbuser" value="<?php echo sval('dbuser', $dbConnectionInfo['dbUser']); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="password" size="45" id="dbpass" name="dbpass" value="<?php echo sval('dbpass', $dbConnectionInfo['dbPassword']); ?>"
